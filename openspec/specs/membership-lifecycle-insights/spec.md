...
The system SHALL classify qualifying membership-dues lines separately from security fees, gifts, tuition, events, sales, and other non-dues products, and SHALL treat missing billing coverage as unknown rather than non-renewal.
...
The system SHALL provide Overview, Jobs, Renewal & Engagement, and Risk views and SHALL compose all aggregate sections in report/PDF mode regardless of the selected screen tab.
...
- **THEN** the PDF contains every aggregate section and no named household Watch List
